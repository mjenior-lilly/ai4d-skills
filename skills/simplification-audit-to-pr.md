...
| --- | --- | --- | --- | --- |
| quick | Single-file or narrow local inspection, no public contracts, no data shape changes, no ambiguous reachability. | GPT-5.5-Terra or Claude Haiku-4.5 | low | 1-3 files or less than 30 minutes expected work |
| standard | Multiple related files, shared helpers, tests, or caller updates with clear ownership. | GPT-5.5-Terra or Claude Sonnet-5 | medium | 4-12 files or 30-120 minutes expected work |
| complex | Boundary contracts, public APIs, schemas, migrations, security, concurrency, generated code, framework discovery, or unclear reachability. | GPT-5.5-Sol or Claude Opus-5 | high | More than 12 files, more than 2 hours expected work, or any high-risk boundary |
| verifier | Independent review, plan critique, audit confirmation, or failure diagnosis. | GPT-5.5-Sol or Claude Opus-5 for complex-tier review | medium by default, high for complex tier changes | Bounded to the reviewed artifact or diff |

Subagent defaults:

- Audit scouts: GPT-5.5-Terra or Claude Sonnet-5 with medium thinking. Use GPT-5.5-Sol or Claude Opus-5 with high thinking for large module maps, dynamic dispatch, framework conventions, public APIs, schemas, persistence, or security-sensitive areas.
- Plan writer: GPT-5.5-Sol or Claude Opus-5 with high thinking for complex findings; GPT-5.5-Terra or Claude Sonnet-5 with medium thinking otherwise.
- Plan reviewer: GPT-5.5-Terra or Claude Sonnet-5 with medium thinking. Use at most one reviewer unless the repository is so large that independent domain review is needed.
- Implementation workers: GPT-5.5-Terra or Claude Sonnet-5 with medium thinking for isolated work packages. Use GPT-5.5-Sol or Claude Opus-5 with high thinking only for boundary contracts or cross-cutting refactors.
- Test and confirmation reviewers: GPT-5.5-Terra or Claude Sonnet-5 with medium thinking. Escalate to GPT-5.5-Sol or Claude Opus-5 with high thinking when failures contradict the plan or expose hidden contracts.
- Commit and PR helper: GPT-5.5-Luna or Claude Haiku-4.5 with low thinking when the diff and validation are already complete.
