...
3. Analyze the justifications by theme: recurring strengths and weaknesses,
   plus insightful observations that appear in only one report.
4. Write one cohesive analytical paragraph, or two at most. Integrate the
   reports into a unified narrative rather than concatenating them. Do not
   repeat near-identical points or omit distinct observations. Use a
